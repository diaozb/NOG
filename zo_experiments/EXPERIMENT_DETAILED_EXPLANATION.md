...
- [完整 ZO 实验计划](PLAN.md)
- [ZO 实验目录索引](README.md)
- [20-seed 正式结果](formal/README.md)
- [理论对照与论文结论边界](formal/STEP_ZO_5C_THEORY_COMPARISON.md)
- [异常与删失审计](formal/STEP_ZO_6A_ANOMALY_AUDIT.md)
- [预留 seed 复现和预算决策](formal/STEP_ZO_6C_REPLICATION_DECISION.md)
- [20-seed dimension sensitivity 结果](dimension/README.md)
- [20-seed logical-worker sensitivity 结果](worker/README.md)
- [真实 Gloo 进程等价性审计](process_equivalence/README.md)
- [a9a/ijcnn1 真实数据正式结果](real_data/README.md)
...
![正式配对 depth/work ratios](formal/figures/formal_ratios.png)
...
- [冻结参数](frozen_parameters.json)
- [正式审计](formal/audit.json)
- [分析清单](formal/analysis_manifest.json)
- [dimension manifest](dimension_scaling_manifest.json)
...
冻结记录位于
[frozen_parameters.json](frozen_parameters.json)。这些参数是在指定
...
![正式 hit/depth/work](formal/figures/formal_hit_depth_work.png)
...
[formal_ratios.csv](formal/formal_ratios.csv) 中查看。
...
![Formal 与 anomaly 复现](formal/figures/anomaly_replication_comparison.png)
...
![全部 proxy trajectories](formal/figures/anomaly_proxy_trajectories.png)

![单 checkpoint 与 confirmed hits](formal/figures/boundary_checkpoint_sensitivity.png)
...
可提交的校准摘要已整理在本节和
[dimension_scaling_manifest.json](dimension_scaling_manifest.json) 中。
...
[完整 ZO-7C 报告、绝对值、paired ratios、bootstrap CI 和删失表](dimension/README.md)

![Dimension absolute metrics](dimension/figures/dimension_hit_depth_work.png)
...
[完整 ZO-8C 报告、same-seed ratios、slopes、终点计费和删失表](worker/README.md)

![Worker absolute metrics](worker/figures/worker_hit_depth_work.png)

![Worker relative metrics](worker/figures/worker_relative_to_m1.png)

## 14. 图表索引

| 图 | 内容 |
|---|---|
| [formal_hit_depth_work.png](formal/figures/formal_hit_depth_work.png) | 四算法 hit rate、绝对 first-hit depth/work |
| [formal_ratios.png](formal/figures/formal_ratios.png) | baseline/NOG-ZO paired depth/work ratios |
| [anomaly_proxy_trajectories.png](formal/figures/anomaly_proxy_trajectories.png) | 20 formal seeds 的完整 proxy 轨迹 |
| [boundary_checkpoint_sensitivity.png](formal/figures/boundary_checkpoint_sensitivity.png) | 单 checkpoint 与连续二点命中规则比较 |
| [anomaly_replication_comparison.png](formal/figures/anomaly_replication_comparison.png) | formal 20 与 anomaly 5 的轨迹诊断对照 |
| [zo_pilot_snapshot.png](figures/zo_pilot_snapshot.png) | 仅用于选参的 pilot snapshot |
| [dimension_hit_depth_work.png](dimension/figures/dimension_hit_depth_work.png) | 四维度 primary hit/depth/work |
| [dimension_ratios.png](dimension/figures/dimension_ratios.png) | 四维度 same-seed paired ratios 与95% CI |
| [worker_hit_depth_work.png](worker/figures/worker_hit_depth_work.png) | 四个 logical-worker 计数下的 hit/depth/work |
| [worker_relative_to_m1.png](worker/figures/worker_relative_to_m1.png) | 相对 m=1 的 same-seed depth/work/per-worker ratios |
| [worker_terminal_accounting.png](worker/figures/worker_terminal_accounting.png) | 固定预算的终点 total/per-worker work 和 proxy |
