...
- 正式结果入口：[zo_experiments/formal/README.md](formal/README.md)；
- 理论解释入口：[zo_experiments/formal/STEP_ZO_5C_THEORY_COMPARISON.md](formal/STEP_ZO_5C_THEORY_COMPARISON.md)；
- ZO-6A 诊断入口：[zo_experiments/formal/STEP_ZO_6A_ANOMALY_AUDIT.md](formal/STEP_ZO_6A_ANOMALY_AUDIT.md)；
...
- 复现与决策：[zo_experiments/formal/STEP_ZO_6C_REPLICATION_DECISION.md](formal/STEP_ZO_6C_REPLICATION_DECISION.md)；
...
- Dimension 结果入口：[zo_experiments/dimension/README.md](dimension/README.md)。
...
- Worker 结果入口：[zo_experiments/worker/README.md](worker/README.md)。
...
- 冻结manifest：[zo_experiments/dimension_scaling_manifest.json](dimension_scaling_manifest.json)；
