...
![Pilot 结果快照](figures/zo_pilot_snapshot.png)
...
![Formal hit rate、absolute depth 和 work](formal/figures/formal_hit_depth_work.png)
...
![Formal paired depth/work ratios](formal/figures/formal_ratios.png)
...
![完整 proxy trajectories](formal/figures/anomaly_proxy_trajectories.png)

![单 checkpoint 与 confirmed-hit 边界](formal/figures/boundary_checkpoint_sensitivity.png)

![Formal 与 reserved anomaly seeds](formal/figures/anomaly_replication_comparison.png)
...
![Worker ratios relative to m=1](worker/figures/worker_relative_to_m1.png)
...
![Worker terminal accounting](worker/figures/worker_terminal_accounting.png)
...
![a9a formal curves](real_data/formal/a9a_formal_curves.png)

![ijcnn1 formal curves](real_data/formal/ijcnn1_formal_curves.png)
...
| 内容 | 文件 |
|---|---|
| ZO 总说明 | [EXPERIMENT_DETAILED_EXPLANATION.md](EXPERIMENT_DETAILED_EXPLANATION.md) |
| 完整实验计划 | [PLAN.md](PLAN.md) |
| 主实验绝对结果 | [formal_summary.csv](formal/formal_summary.csv) |
| 主实验 paired ratios | [formal_ratios.csv](formal/formal_ratios.csv) |
| 主实验审计 | [audit.json](formal/audit.json) |
| 理论比较 | [theory_comparison.json](formal/theory_comparison.json) |
| 删失与异常报告 | [STEP_ZO_6A_ANOMALY_AUDIT.md](formal/STEP_ZO_6A_ANOMALY_AUDIT.md) |
| reserved-seed 决策 | [STEP_ZO_6C_REPLICATION_DECISION.md](formal/STEP_ZO_6C_REPLICATION_DECISION.md) |
| dimension 完整报告 | [README.md](dimension/README.md) |
| dimension summary | [dimension_summary.csv](dimension/dimension_summary.csv) |
| dimension ratios | [dimension_ratios.csv](dimension/dimension_ratios.csv) |
| worker 完整报告 | [README.md](worker/README.md) |
| worker summary | [worker_summary.csv](worker/worker_summary.csv) |
| worker ratios | [worker_relative_to_m1.csv](worker/worker_relative_to_m1.csv) |
| Gloo 等价审计 | [equivalence_audit.json](process_equivalence/equivalence_audit.json) |
| 真实数据完整报告 | [README.md](real_data/README.md) |
| 真实数据 summary | [summary.csv](real_data/formal/summary.csv) |
| 真实数据冻结参数 | [frozen_parameters.json](real_data/frozen_parameters.json) |

复现入口和分步命令详见 `EXPERIMENT_DETAILED_EXPLANATION.md` 的运行方法部分。所有正式分析器只读取冻结后的 raw trajectories，不使用 formal 结果重新选择参数。
